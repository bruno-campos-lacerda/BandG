...
public class DataBaseConection {
    ...
    public static void main(String[] args){
        SelectData select = new SelectData("select");
        select.setPriority(1);
        
        InsertData insert = new InsertData("insert");
        insert.setPriority(2);
        
        UpdateData update = new UpdateData("update");
        update.setPriority(3);
